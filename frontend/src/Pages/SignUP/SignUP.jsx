      ...
      <div className="relative z-10 grid min-h-screen w-full lg:grid-cols-2">
        <section className="hidden min-h-screen flex-col justify-center px-10 py-10 lg:flex xl:px-20">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-7 max-w-lg text-base leading-8 text-slate-500 dark:text-gray-400 xl:text-lg">
              Create your account and start discovering Egypt your way, from
              unforgettable destinations to unique travel experiences.
            </p>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500 dark:text-gray-400">
                  Organize your trips and experiences with ease.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500 dark:text-gray-400">
                  Make every moment of your Egyptian journey memorable.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="flex min-h-screen items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-3xl border mt-10 border-slate-200/80 bg-white/80 p-6 shadow-[0_25px_80px_rgba(31,41,55,0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-white/4 dark:shadow-black/30 sm:p-10">
              <div className="mb-8">
                ...
                <p className="mt- text-sm leading-6 text-slate-500 dark:text-gray-400">
                  Create your account and start exploring Egypt with Kemora.
                </p>
              </div>
